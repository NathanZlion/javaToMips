...
public class unwrap {
    ...
    private static String removeOuterClassAndFunction(String code) {
    ...
    private static String getContentInMainFunction(String code) {
        ...
        String functionContent = code.substring(braceStart, braceEnd + 1);

        return functionContent.trim();
    }

    public static String unwrapCode(String code) {
        String result = getContentInMainFunction(removeOuterClassAndFunction(code));
